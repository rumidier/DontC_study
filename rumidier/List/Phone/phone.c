                  ...
                  char         *str)
{
  if (!strcmp (person->eig_no, str))
    return 1;
  else if (!strcmp (person->ko_name, str))
    return 1;
  else if (!strcmp (person->en_name, str))
    return 1;
  else if (!strcmp (person->nick_name, str))
    return 1;
  else if (!strcmp (person->my_tel, str))
    return 1;
  else if (!strcmp (person->home_tel, str))
    return 1;
  else if (!strcmp (person->work_tel, str))
    return 1;
  else if (!strcmp (person->home_addr, str))
    return 1;
  else if (!strcmp (person->work_addr, str))
    return 1;
  else if (!strcmp (person->my_email, str))
    return 1;
  else if (!strcmp (person->work_email, str))
    return 1;
  else if (!strcmp (person->my_homepage, str))
    return 1;
  else if (!strcmp (person->twitter, str))
    return 1;
